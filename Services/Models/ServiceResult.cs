//using RLCMarketPlace.DTO.ViewModel;
//using System;
...
//            return result;
//        }
//        public static ServiceResult<TData> TAddedSuccessfully<TData>(string value, TData data)
//        {
//            string message = $"{value} successfully added";
//            var result = new ServiceResult<TData>(null, true, message, data);
//            return result;
//        }
...
//        {
//            public static ServiceResult Blocked(string value)
//            {
//                string message = $"{value} blocked";
//                var result = new ServiceResult(new ErrorResponse(nameof(Blocked), message), false, message);
//                return result;
//            }
...
//                var result = new ServiceResult(new ErrorResponse(nameof(Required), message), false, message);
//                return result;
//            }
...
//            {
//                string message = $"{value} required";
//                var result = new ServiceResult<TData>(new ErrorResponse(nameof(Required), message), false, message, data);
//                return result;
//            }
//            public static ServiceResult Invalid1(string value)
//            {
...
//            public static ServiceResult<TData> Invalid1<TData>(string value, TData data)
//            {
//                string message = $"{value}";
...
//            public static ServiceResult UserBlocked()
//            {
//                string message = $"User Blocked";
//                var result = new ServiceResult(new ErrorResponse(nameof(InvalidJwtToken), message), false, message);
//                return result;
//            }
//            public static ServiceResult<TData> UserBlocked<TData>(TData data)
//            {
//                string message = $"User Blocked";
//                var result = new ServiceResult<TData>(new ErrorResponse(nameof(UserBlocked), message), false, message, data);
//                return result;
//            }
